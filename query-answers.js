// Encodes questionnaire answers into a compact URL query parameter.
(function () {
  'use strict';
  ...
  function write(answers, questions) {
  ...
  function encode(answers, questions) {
    let mask = 0n;
  ...
  function decode(encoded, questions) {
